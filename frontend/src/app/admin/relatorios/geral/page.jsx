    ...
    <>
      ...
      <div className="min-h-screen p-6 sm:p-10 animate-fadeIn flex flex-col gap-8">
        <div className="max-w-7xl mx-auto space-y-12">
          {/* Cabeçalho */}
          <div className="bg-[#B0FF8F] rounded-3xl shadow-xl p-6 flex flex-col gap-4">
            <div className="text-center mb-6">
              <h1 className="text-3xl sm:text-4xl font-extrabold text-[#4E8A3D] mb-2 flex items-center justify-center gap-3">
                <TrendingUp size={36} />
                Relatório Geral
              </h1>
              <p className="text-[#4E8A3D] text-lg">
                Visão completa do desempenho da matriz e filiais
              </p>
              {data?.periodo && (
                <p className="text-sm text-[#4E8A3D] mt-2">
                  Período:{" "}
            ...
            {/* Filtros */}
            <div className="bg-[#EBC7F5] p-6 rounded-2xl border-2 border-[#e8c5f1] space-y-4">
              ...
              <div className="flex flex-wrap gap-2 mb-4">
                <button
                  ...
                  className="px-4 py-2 bg-[#76196c] hover:bg-[#9b2b91] text-[#CAF4B7] text-sm rounded-xl transition-all"
                >
                  Últimos 7 dias
                </button>
                <button
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
                <div>
                  ...
                  <input
                    ...
                    className="w-full bg-[#EBC7F5] p-3 rounded-xl border-2 border-[#d695e7] focus:ring-2 focus:ring-[#76196c] transition-all"
                  />
                </div>
                ...
                <div className="flex items-end gap-2">
                  <button
                    ...
                    disabled={loading}
                    className="flex-1 flex items-center justify-center gap-2 bg-[#9BF377] hover:bg-[#9BF377]/80 text-[#76216D] font-bold py-3 rounded-xl transition-all disabled:opacity-50"
                  >
                    {loading ? (
                  ...
                  <button
                    ...
                    className="px-4 py-3 bg-[#9BF377] hover:bg-[#9BF377]/80 text-[#76216D] font-bold rounded-xl transition-all"
                  >
                    Limpar
                  </button>
                </div>
            ...
            {data?.topProdutos && data.topProdutos.length > 0 && (
              <div className="bg-[#CAF4B7] p-6 rounded-2xl shadow-xl space-y-4">
                ...
                <div className="overflow-x-auto mt-2">
                  <table className="w-full border-collapse">
                    <thead>
                      <tr className="bg-[#70B64C]/40 border-b-2 border-[#75BA51]">
                    ...
                    <tbody>
                      {data.topProdutos.map((p, idx) => (
                        <tr
                          key={p.id_produto}
                          className="border-b border-[#70B64C] hover:bg-[#70B64C]/20 transition-colors"
                        >
                          <td className="p-4">
                            <span
                          ...
                          <td className="p-4 font-medium text-[#4F6940] ">
            ...
            {data?.ultimasVendas && data.ultimasVendas.length > 0 && (
              <div className="bg-[#D695E7] p-6 rounded-2xl shadow-xl space-y-4">
                <h2 className="text-2xl font-bold text-[#76196c] mb-4 flex items-center gap-2">
                ...
                <div className="overflow-x-auto mt-2">
                  <table className="w-full border-collapse">
                    <thead>
                      <tr className="bg-[#E5B8F1] border-b-2 border-[#d695e7]">
                        <th className="p-4 text-left text-[#76196c] font-bold">
                          ID
                        </th>
                        <th className="p-4 text-left text-[#76196c] font-bold">
                    ...
                    <tbody>
                      {data.ultimasVendas.slice(0, 10).map((v) => (
                        <tr
                          key={v.id_venda}
                          className="border-b border-[#E5B8F1] hover:bg-[#76226D]/20 transition-colors"
                        >
                          <td className="p-4">
                          ...
                          <td className="p-4">
                            <span className="capitalize bg-[#F1B8E8] text-[#76226D] px-3 py-1 rounded-lg text-sm font-medium">
                              {v.tipo_pagamento}
                            </span>
                          </td>
            ...
            {data?.topDespesas && data.topDespesas.length > 0 && (
              <div className="bg-[#75BA51] p-6 rounded-2xl shadow-xl space-y-4">
                <h2 className="text-2xl font-bold text-[#C5FFAD] mb-4 flex items-center gap-2">
                ...
                <div className="overflow-x-auto mt-2">
                  <table className="w-full border-collapse">
                    <thead>
                      <tr className="bg-[#C5FFAD] border-b-2 border-[#d695e7]">
                        <th className="p-4 text-left text-[#76196c] font-bold">
                          ID
                        </th>
                        <th className="p-4 text-left text-[#76196c] font-bold">
                    ...
                    <tbody>
                      {data.topDespesas.map((d) => (
                        <tr
                          key={d.id_despesa}
                          className="border-b border-[#C5FFAD] hover:bg-[#569A33]/70 transition-colors"
                        >
                          <td className="p-4">
                            <span className="font-mono text-sm bg-[#e8c5f1] text-[#76196c] px-3 py-1 rounded-lg">
                              #{d.id_despesa}
                          ...
                          <td
                            className="p-4 text-sm max-w-md text-[#C5FFAD] truncate"
                            title={d.descricao}
                          >
                            {d.descricao}
                          </td>
                          <td className="p-4 font-bold text-[#E5B8F1]">
                            R${" "}
                            {parseFloat(d.preco).toLocaleString("pt-BR", {
                              minimumFractionDigits: 2,
                            })}
                          </td>
                          <td className="p-4 text-[#C5FFAD]">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
              ...
              <Card className=" bg-[#B478AB]">
                <CardContent className="p-6">
                  <div className="flex items-center justify-between">
                    <div>
                      <p className="text-sm text-[#76196C] font-medium">
                        Margem de Lucro
                      </p>
            ...
            {data?.rankingFiliais && data.rankingFiliais.length > 0 && (
              <div className=" p-6 space-y-4">
                ...
                <div className="overflow-x-auto mt-2">
                  <table className="w-full border-collapse">
                    <thead>
                      <tr className=" border-b-2 border-[#934788]">
                        <th className="p-4 text-left text-[#76196c] font-bold">
                          #
                        </th>
                        <th className="p-4 text-left text-[#76196c] font-bold">
                    ...
                    <tbody>
                      {data.rankingFiliais.map((f, idx) => (
                        <tr
                          key={f.id_empresa}
                          className="border-b border-[#934788] hover:bg-[#934788]/40 transition-colors"
                        >
                          <td className="p-4">
                            <span
                              className={`inline-flex items-center justify-center w-8 h-8 rounded-full font-bold ${idx === 0
                          ...
                          <td className="p-4 font-medium text-[#934788]">{f.total_vendas}</td>
                          <td className="p-4 text-[#4EA912] font-bold">
                            R${" "}
                          ...
                          <td className="p-4">
                            <span
                              className={`px-3 py-1 rounded-lg text-sm font-medium ${parseFloat(f.faturamento) > 0
            ...
            {data?.ultimasDespesas && data.ultimasDespesas.length > 0 && (
              <div className="p-6 space-y-4">
                ...
                <div className="overflow-x-auto mt-2">
                  <table className="w-full border-collapse">
                    <thead>
                      <tr className="border-b-2 border-[#4F6940]">
                        <th className="p-4 text-left text-[#76196c] font-bold">
                          ID
                        </th>
                        <th className="p-4 text-left text-[#76196c] font-bold">
                    ...
                    <tbody>
                      {data.ultimasDespesas.slice(0, 15).map((d) => (
                        <tr
                          key={d.id_despesa}
                          className="border-b border-[#4F6940] hover:bg-[#4F6940]/30 transition-colors"
                        >
                          <td className="p-4">
                            <span className="font-mono text-sm bg-[#e8c5f1] text-[#76196c] px-3 py-1 rounded-lg">
                              #{d.id_despesa}
                          ...
                          <td
                            className="p-4 text-sm text-[#76196C] max-w-md truncate"
                            title={d.descricao}
                          >
                            {d.descricao}
                          </td>
