...
const GerenteVendasPage = () => {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-[#DDF1D4] to-[#9bf377] p-6">
      <div className="max-w-7xl mx-auto">
        {/* Header */}
        <div
          className="bg-white border-[3px] border-dashed rounded-[50px] shadow-lg p-6 mb-6"
          style={{ borderColor: TIKI.roxoMedio }}
        >
          <div className="flex items-center justify-between mb-6">
            <div>
              ...
              >
                <Package size={36} style={{ color: TIKI.roxoMedio }} />
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
            <div>
              ...
              <input
                ...
                className="w-full px-4 py-2 border-[3px] border-dashed rounded-xl focus:outline-none focus:ring-2"
                style={{
                  borderColor: TIKI.roxoClaro,
                  "--tw-ring-color": TIKI.roxoMedio,
                }}
              />
            </div>
            <div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-6">
          <div
            className="rounded-[50px] shadow-lg p-6 text-white border-[3px] border-dashed"
            style={{
          ...
          <div
            className="rounded-[50px] shadow-lg p-6 border-[3px] border-dashed"
            style={{
          ...
          >
            <div className="flex items-center justify-between">
              <div>
                <p className="text-sm font-semibold opacity-90">Ticket Médio</p>
                <p className="text-3xl font-bold mt-2">
                  {qtdVendas > 0
        ...
        <div className="space-y-4">
          {vendasFiltradas().length === 0 ? (
            <div
              className="bg-white rounded-[50px] border-[3px] border-dashed shadow-lg p-12 text-center"
            ...
            vendasFiltradas().map((venda) => (
              <div
                key={venda.id_venda}
                className="bg-white rounded-[30px] border-[3px] border-dashed shadow-lg overflow-hidden transition-all hover:shadow-xl"
                style={{ borderColor: TIKI.roxoClaro }}
              >
                <div
                ...
                >
                  <div className="flex items-center justify-between">
                    <div className="flex items-center gap-6 flex-1">
                      <div
                        className="rounded-2xl p-3 border-[3px] border-dashed"
                        style={{
                          backgroundColor: TIKI.rosaClaro,
                          borderColor: TIKI.roxoClaro,
                        }}
                      >
                        <Package size={24} style={{ color: TIKI.roxoMedio }} />
                      </div>
                      <div className="flex-1">
                        <div className="flex items-center gap-3 mb-2">
                          <span
                            ...
                            style={{ color: TIKI.roxoEscuro }}
                          >
                            Venda #{venda.id_venda} - Caixa {venda.id_caixa}
                          </span>
                          <span className="text-2xl">
                            {getTipoPagamentoIcon(venda.tipo_pagamento)}
                          </span>
                          <span
                            className="px-3 py-1 rounded-full text-sm font-semibold border-[2px] border-dashed"
                            style={{
                ...
                >
                  <div
                    className="border-t-[3px] border-dashed p-6"
                    style={{
                      borderColor: TIKI.roxoClaro,
                    ...
                    <div className="space-y-3">
                      {venda.itens.map((item) => {
                        ...
                        return (
                          <div
                            key={item.id_item}
                            className="bg-white rounded-[20px] p-4 shadow-sm hover:shadow-md transition-all duration-300 border-[2px] border-dashed transform hover:scale-[1.01]"
                            style={{ borderColor: TIKI.roxoClaro }}
                          >
                            <div className="flex items-center gap-4">
                              {produto.imagem && (
                                <img
                                  src={produto.imagem}
                                  alt={produto.nome}
                                  className="w-16 h-16 object-cover rounded-xl border-[3px] border-dashed"
                                  style={{ borderColor: TIKI.roxoClaro }}
                                  onError={(e) => {
                              ...
                              <div className="flex-1">
                                ...
                                {produto.categoria && (
                                  <span
                                    className="inline-block mt-2 px-2 py-1 rounded-lg text-xs font-semibold border-[2px] border-dashed"
                                    style={{
                                      backgroundColor: TIKI.rosaTikitos,
                                      color: TIKI.roxoEscuro,
                                      borderColor: TIKI.roxoClaro,
                              ...
                              <div className="text-right">
                                <div className="flex items-center gap-4">
                                  ...
                                  <div
                                    className="ml-4 px-4 py-2 rounded-[20px] border-[3px] border-dashed"
                                    style={{
