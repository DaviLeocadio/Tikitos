    ...
    <div className="min-h-screen bg-[#F3FFE8] p-4 md:p-8">
      <div className="max-w-7xl mx-auto">
        ...
        <div className="w-full flex flex-col lg:flex-row lg:h-auto gap-6">
          ...
          {/* GRÁFICO */}
          <div
            className="bg-[#F0FFE7] border-4 border-dashed border-[#C57ED9] rounded-3xl p-6 shadow-md 
                          w-full lg:w-3/4"
          >
        ...
        <div className="flex flex-col lg:flex-row w-full gap-6 mt-6">
          {/* Fechamento do Caixa */}
          <div
            className="w-full lg:w-1/4 bg-[#FAD9FF] border-4 border-dashed border-[#C57ED9] 
          ...
          <div className="w-full lg:w-3/4 flex flex-col gap-6">
            ...
            <div className="flex flex-col md:flex-row gap-6">
              ...
              <div
                className="w-full md:w-1/3 bg-[#E1FFD2] border-4 border-dashed border-[#8FD671] 
                              rounded-3xl p-6 shadow-md"
              >
              ...
              <div
                className="w-full md:w-1/3 bg-[#FAD9FF] border-4 border-dashed border-[#C57ED9] 
                              rounded-3xl p-6 shadow-md"
              >
                <div className="flex items-center gap-3 mb-3">
            ...
            <div className="flex flex-col md:flex-row gap-6">
              ...
              {/* Histórico */}
              <div
                className="w-full md:w-2/3 aspect-2/1 bg-[#E1FFD2] border-4 border-dashed border-[#8FD671] 
                              rounded-3xl p-6 shadow-md"
              >
                <div className="flex items-center gap-3 mb-3">
