        ...
        <>
            <Card className="group min-w-53 shadow-none gap-0 pt-0 pb-0 bg-[#D8F1DC] border-[3px] border-dashed border-[#75ba51] rounded-[50px] p-2 hover:bg-[#C8FDB4] transition">
                <CardHeader className="pt-3 px-6 flex items-center flex-row justify-between gap-2 font-semibold text-sm">
                    ...
                    <div className="w-11 h-full flex justify-between items-center">
                        <i className="bi bi-info-circle-fill text-[16px] text-[#569a33] hover:scale-95 transition"></i>
                        <i className="bi bi-exclamation-circle-fill gap-3 text-[16px] text-[#4f6940] hover:scale-95 transition"></i>
                    </div>
                </CardHeader>
