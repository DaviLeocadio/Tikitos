...
const VendedoresTable = memo(function VendedoresTable({
  ...
  return (
    <div className=" rounded-xl border-3 border-dashed border-[#4EA912] overflow-hidden">
      <div className="overflow-x-auto">
        <Table>
          <TableHeader className="bg-[#75BA51]">
              ...
              table.getRowModel().rows.map((row) => (
                <TableRow
                  ...
                  className={`${row.index % 2 === 0
                      ? "bg-[#EBC7F5]"   // linha PAR - verde claro
                      : "bg-[#E5B8F1]"   // linha ÍMPAR - ainda mais claro
                    } hover:!bg-[#D594E6]/50`}
                >
      ...
      {/* Paginação */}
      <div className="flex bg-[#75BA51]/60 items-center justify-between p-4 border-t border-[#b478ab]/30">
        <div className="text-sm text-[#8c3e82]">
          ...
          de {table.getFilteredRowModel().rows.length} gerentes
        </div>
