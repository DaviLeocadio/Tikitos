...
export default function AtalhosDiv() {
  ...
  const handleKeyDown = async (event) => {
    ...
    if (event.keyCode === 27) {
      const fecharCaixa = await fetch("http://localhost:8080/vendedor/caixa/fechar", {
        method: "PUT",
        credentials: "include",
      });
    ...
    <>
      <div className="hidden w-full lg:flex bg-[#9BF377] border-[3px] border-dashed border-[#b478ab] rounded-[50px]  p-2 px-5 text-[#8c3e82] text-sm font-semibold justify-between">
        ...
        <div className="gap-2 flex">
          ...
          <h3>
            Resetar o carrinho: <span className="bold">INSERT</span>
          </h3>
        </div>
        ...
        <div className="gap-2 flex">
          ...
          <h3>
            Voltar o item excluído: <span className="bold">F2</span>{" "}
          </h3>
        </div>
        ...
        <div className="gap-2 flex">
          ...
          <h3>
            Página de suporte: <span className="bold">F4</span>{" "}
          </h3>
        </div>
        ...
        <div className="gap-2 flex">
          ...
          <h3>
            Voltar ao login: <span className="bold">ESC</span>
          </h3>
        </div>
      </div>
    </>
