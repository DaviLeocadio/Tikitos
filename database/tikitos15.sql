CREATE DATABASE  IF NOT EXISTS `tikitos` /*!40100 DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci */;
USE `tikitos`;
...
INSERT INTO `caixa` VALUES (3,100,200,'2025-10-05 14:22:45','2025-10-05 20:02:09',100.00,898.50,'fechado'),(6,101,200,'2025-11-06 21:35:10','2025-11-24 21:55:48',100.00,791.30,'fechado'),(7,101,200,'2025-11-01 21:56:09','2025-12-04 17:37:34',100.00,1327.80,'fechado'),(8,101,200,'2025-11-01 21:56:09','2025-12-04 17:41:49',100.00,100.00,'fechado'),(9,101,200,'2025-12-04 19:18:06','2025-12-04 19:18:55',100.00,100.00,'fechado'),(10,101,200,'2025-12-04 19:21:54','2025-12-04 19:48:22',100.00,449.10,'fechado'),(11,101,200,'2025-12-04 19:48:46','2025-12-04 19:48:52',100.00,100.00,'fechado'),(12,101,200,'2025-12-04 19:49:07','2025-12-04 19:54:27',100.00,100.00,'fechado'),(13,101,200,'2025-12-04 19:54:51','2025-12-04 19:54:56',100.00,100.00,'fechado'),(14,101,200,'2025-12-04 19:59:22','2025-12-04 19:59:43',100.00,100.00,'fechado'),(15,101,200,'2025-12-04 20:55:33','2025-12-04 21:43:40',100.00,100.00,'fechado'),(16,101,200,'2025-12-04 21:45:56','2025-12-04 21:48:51',100.00,100.00,'fechado'),(17,101,200,'2025-12-04 21:57:26','2025-12-04 21:59:31',100.00,100.00,'fechado'),(18,101,200,'2025-12-04 22:04:01','2025-12-04 22:19:36',100.00,100.00,'fechado'),(19,101,200,'2025-12-05 08:02:24','2025-12-05 08:03:59',100.00,100.00,'fechado'),(20,101,200,'2025-12-05 08:08:23','2025-12-05 08:33:43',100.00,100.00,'fechado'),(21,101,200,'2025-12-05 08:33:51','2025-12-05 09:47:42',100.00,779.40,'fechado'),(22,101,200,'2025-12-05 09:50:33','2025-12-05 11:13:22',100.00,256.60,'fechado'),(23,101,200,'2025-12-05 13:20:50','2025-12-05 13:29:10',100.00,100.00,'fechado'),(24,101,200,'2025-12-05 13:44:05','2025-12-05 13:59:58',100.00,100.00,'fechado'),(25,101,200,'2025-12-05 15:06:57','2025-12-05 15:10:58',100.00,186.70,'fechado'),(26,113,200,'2025-12-05 15:23:26',NULL,100.00,200.00,'aberto'),(27,101,200,'2025-12-05 16:16:19','2025-12-06 16:59:39',100.00,296.50,'fechado'),(28,101,200,'2025-12-06 17:01:56','2025-12-06 17:41:59',100.00,145.90,'fechado'),(29,101,200,'2025-12-06 17:42:05','2025-12-08 15:55:22',100.00,200.00,'fechado'),(30,101,200,'2025-12-01 15:55:48',NULL,100.00,100.00,'aberto');
...
CREATE TABLE `despesas` (
  ...
  KEY `id_empresa` (`id_empresa`),
  KEY `fk_despesas_fornecedor` (`id_fornecedor`),
  CONSTRAINT `despesas_ibfk_1` FOREIGN KEY (`id_empresa`) REFERENCES `empresas` (`id_empresa`),
  CONSTRAINT `fk_despesas_fornecedor` FOREIGN KEY (`id_fornecedor`) REFERENCES `fornecedores` (`id_fornecedor`) ON DELETE SET NULL ON UPDATE CASCADE
...
INSERT INTO `despesas` VALUES (3,200,'2025-10-06','2025-10-06','Compra de brinquedos de reposição',NULL,890.00,'pago'),(4,200,'2025-10-10','2025-10-10','Serviço de limpeza externa',NULL,250.00,'pago'),(5,200,'2025-10-15','2025-10-18','Conta de energia elétrica',NULL,430.75,'pago'),(6,200,'2025-10-20','2025-12-05','Material de escritório',NULL,120.00,'pago'),(7,200,'2025-11-05','2025-11-30','Compra de embalagens',NULL,139.90,'pago'),(10,200,'2025-11-02','2025-11-03','Compra de embalagens e sacolas',NULL,245.90,'pago'),(11,200,'2025-11-05','2025-11-05','Manutenção do ar-condicionado',NULL,320.00,'pago'),(13,200,'2025-11-10','2025-11-10','Conta de água',NULL,189.30,'pago'),(19,200,'2025-11-23','2025-11-23','Internet e telefone',NULL,199.90,'pago'),(22,200,'2025-11-27','2025-12-05','Pedido: 10 unidades de Boneka Dora do fornecedor Tikitos Indústria de Brinquedos S.A. - R$ 28,00 × 10 : R$ 280,00',NULL,280.00,'pago'),(23,200,'2025-11-29','2025-11-30','Pedido: 5 unidades de Kachorrilo do fornecedor Tikitos Indústria de Brinquedos S.A. - R$ 22,00 × 5 : R$ 110,00',NULL,110.00,'pago'),(24,200,'2025-11-29','2025-11-30','Pedido: 5 unidades de Boneko Igolinho do fornecedor Tikitos Indústria de Brinquedos S.A. - R$ 30,00 × 5 : R$ 150,00',NULL,150.00,'pago'),(25,200,'2025-11-29','2025-11-28','Pedido: 5 unidades de Senhor Patonildo do fornecedor Tikitos Indústria de Brinquedos S.A. - R$ 12,00 × 5 : R$ 60,00',NULL,60.00,'pendente'),(27,100,'2025-12-05','2025-12-05','Conta de luz',NULL,100.00,'pago'),(28,100,'2025-12-05','2025-12-05','Manutenção da porta banheiro',NULL,200.00,'pago'),(29,100,'2025-12-05','2025-12-05','Manutenção da porta do banheiro',NULL,200.00,'pago'),(30,100,'2025-12-05','2025-12-05','Pedido 2',NULL,300.00,'pendente'),(31,100,'2025-12-05','2025-12-05','Pedido 2',NULL,100.00,'pendente'),(32,100,'2025-12-08','2025-12-08','Pedido de Brinquedo',3,200.00,'pago'),(34,100,'2025-12-08','2025-12-08','Conta de água ',NULL,200.00,'pago');
...
CREATE TABLE `fornecedores` (
  ...
  `tipo` enum('mercadorias','suprimentos') NOT NULL DEFAULT 'mercadorias',
...
INSERT INTO `fornecedores` VALUES (1,'Tikitos Indústria de Brinquedos S.A.','mercadorias','12.345.678/0001-90','(11) 3456-7890','contato@tikitos.com.br','Av. Central, 1200 - São Paulo/SP','São Paulo','SP','2025-10-15','ativo'),(2,'Embalagens Criativas LTDA','suprimentos','45.987.654/0001-22','(21) 2222-3344','suporte@embalagenscriativas.com','Rua das Embalagens, 88 - Rio de Janeiro/RJ','Rio de Janeiro','RJ','2025-10-15','ativo'),(3,'Transportadora Alegria Express','suprimentos','78.654.321/0001-55','(31) 99888-7766','logistica@alegriaexpress.com','Rodovia BR-040, Km 512 - Belo Horizonte/MG','Belo Horizonte','MG','2025-10-15','ativo'),(4,'teste','suprimentos','00.000.000/0000-00','(00) 0000-0000','teste@teste.com','Endereço de teste','Teste','TT','2025-12-05','inativo');
...
-- Dump completed on 2025-12-08 16:55:21
